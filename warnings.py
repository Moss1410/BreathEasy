...
class Warnings():
    def __init__(self):
        ...
        self.eTv_not_achieved = Warning('eTv not achieved',4,0,10,2,'%',inc.expiratory_flow)
        self.iTv_not_achieved = Warning('iTv not achieved',4,0,10,2,'%',inc.expiratory_flow)
